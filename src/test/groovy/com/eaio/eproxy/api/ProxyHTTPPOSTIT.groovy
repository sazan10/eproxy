 ...
 * doesn't follow POST redirects by default. 
 * 
...
@WebIntegrationTest(value = [ 'http.maxRedirects=1', 'http.followPOSTAndDELETE=true', 'cookies.enabled=false' ], randomPort = true)
class ProxyHTTPPOSTIT {
